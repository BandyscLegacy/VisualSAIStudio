...
namespace DynamicTypeDescriptor
{
  ...
  internal partial class StandardValueEditorUI : UserControl
  {
    ...
    void UpdateCheckState()
    {
      ...
      {
        TagItem ti = lvi.Tag as TagItem;
        bool bitExist = DoBitsExist(m_EnumDataType, m_Value, ti.Item.Value);
        if (lvi.Checked != DoBitsExist(m_EnumDataType, m_Value, ti.Item.Value))
        {
          ti.SetByCode = true;
    ...
    private void StandardValueEditorUI_Load(object sender, EventArgs e)
    {
